...
const int patchSize = 5;        // unused in the demo, it's the Omega
const int minThreshold = 60;    // T
const int omega = 0.95f;        // must be between 0 and 1 (used for maintaining a certain amount of haze, in order to make a natural image)
